import type { DevServerState, ServerSetupInfo, WorkspaceHomeInfo } from "@/lib/messaging";
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="rounded-md border border-border bg-card p-4 flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button variant="outline" onClick={onCopyAuthToken}>
            Copy Auth Token
          </Button>
          {setup.canCreateModalSecret && (
            <Button variant="outline" onClick={onCreateModalSecret}>
              Create Modal Secret
            </Button>
          )}
          <Button variant="outline" onClick={onRevealAssets}>
